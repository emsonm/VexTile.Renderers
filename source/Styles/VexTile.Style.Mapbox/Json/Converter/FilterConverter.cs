...
public class FilterConverter : JsonConverter
{
    ...
    public static IFilter ConvertCompoundFilter<T>(JArray filter) where T : CompoundFilter
    {
    ...
    public static IFilter ConvertExpressionFilter(JArray filter)
    {
        // TODO
